...
- [ ] При стейдже файла выделять в панели Diff следующий
- [ ] При стейдже первого чанка перерисовать Diff панель
- [ ] Выделить в Diff панеле конкретные изменения, которые застейджатся, на фоне остальных строк
- [ ] Добавить в панель Branches в контекстное меню на Local Branches команду New Branch
- [ ] Показать изменения коммита (может отдельное окно "Log")
...
- [x] Название директории сделать серым и без слеша в конце
...
- [x] Разделить название файла и путь к директории
- [ ] Index Editor
  - [ ] 
...
- [x] Добавить удаление для веток у Remotes
- [x] Убрать Apply/Drop у не Stash
